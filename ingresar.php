	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="login-form">
        ...
        <div class="form-group col-xs-12 col-sm-8 col-md-9">
			...
			<div class="form-group col-xs-12 col-sm-8 col-md-9">
				<form class="form-signin form-inline" method="post" id="regresr" action="index.php">
					<div class="col-md-3">
					<button class="btn btn-danger" value="Regresa" name="Regresa">Regresar al Men&uacute;</button>
					</div>
				</form>
				<form class="form-signin form-inline" method="post" id="regrsr" action="recuperar.php">
					<div class="col-md-3">
					<button class="btn btn-info" value="Recupera" name="Recupera">Recuperar Clave</button>
					</div>
				</form>
			</div>
        </div>  
