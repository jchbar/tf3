...
<html lang="en">
  ...
  <?php include("modal_reportarpago.php");?>
  <?php include("modal_reversar.php");?>
  <?php // include("modal_eliminar.php");?>
  <?php // include("modal_imprimir.php");?>
    <div class="container-fluid">
	 
		<div class='col-xs-6'>	
			<h3> Tr&aacute;mites con estatus <strong>Pendientes</strong></h3>
		</div>
		<!-- <div class='col-xs-6'>
			<h3 class='text-right'>		
	...
	<script src="js/app_movimientos.js"></script>
	<script>
