...
function paginate($reload, $page, $tpages, $adjacents) {
	...
	if($page==1) {
		...
		$out.= "<li><span><a href='?page=1'>$prevlabel</a></span></li>";
	}else {
		// $out.= "<li><span><a href='javascript:void(0);' onclick='load(".($page-1).")'>$prevlabel</a></span></li>";
		$out.= "<li><span><a href='?page=".($page-1)."'>$prevlabel</a></span></li>";
	...
	if($page<($tpages-$adjacents)) {
		...
		$out.= "<li><a href='?page=".$tpages."'>$tpages</a></li>";
	}
	...
	if($page<$tpages) {
		...
		$out.= "<li><span><a href='?page=".($page+1)."'>$nextlabel</a></span></li>";
	}else {
