...
{
window.open("rpt_usuarios_pdf.php","parte1","top=0,left=395,status=no,toolbar=no,scrollbar=yes,location=no,type=fullWindow,fullscreen");	// los primeros 500 socios	width=385,height=180,
...
if (!$accion) {
	...
	echo "<h3><strong> Reporte de Usuarios del Sistema Administrativo </strong></h3>";
	echo "</div>";
	echo "<div id='div1'>";
...
else
{
	echo '<div class="container-fluid">';
	echo "<div class='col-xs-6'>";
	echo "<h3><strong> El Reporte de Usuarios del Sistema Administrativo se est&aacute; generando en nueva ventana independiente</strong></h3>";
	echo "</div>";
	echo "<div id='div1'>";
	echo '</div>';
	echo '</div>';
