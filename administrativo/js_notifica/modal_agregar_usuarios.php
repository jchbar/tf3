    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<div class="form-group col-xs-12">
				...
				<input type="email" class="form-control" id="mail" name="mail" required maxlength="100" size="50"  data-error="Ups!!!...., No es una direccion valida" required autocomplete="off" >
				<div class="help-block with-errors"></div>
			</div>
