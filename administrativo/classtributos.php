...
*/
	...
	?>
		...
		<?php
			$sql="select *, concat(substr(concepto,1,70),'...') as cuento from campos order by articulo"; // limit 20";
	...
	function ahora()
{
	...
	function recuperar_clave()
	{
		...
		$chequeo="select * from ingreso_usuario where (email = '".$_POST['inputEmail']."')";
		...
		else 
		{
			...
			$sql="UPDATE usuarios SET clave = substr(MD5'".$nueva."'),2,8) WHERE (email = '".$_POST['inputEmail']."')";
			// echo $sql;
