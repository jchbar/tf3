...
// alert('1');
	var linea='ajx/buscarpwd.php?codigousuario=' + document.getElementById('id').value +'&pp=' + document.getElementById('pwdvieja').value;
//	alert(linea);
...
function cambiopwd() {
//	alert('a')
document.getElementById('respwd').innerHTML = ""; // + xmlDoc.getElementsByTagName("nombreseniat")[0].childNodes[0].nodeValue;
...
//	alert('obtenido '+xmlDoc.getElementsByTagName("obtenido")[0].childNodes[0].nodeValue);
	if (xmlDoc.getElementsByTagName("obtenido")[0].childNodes[0].nodeValue=="1")
	{
		...
		getElementsByTagName('inputNewPassword1')[0].focus();
	}
	else
	{
...
*/
	...
	document.getElementById('resultado').innerHTML = 'Buscando informaci&oacuten ' +  document.getElementById('vieja').value+ "<img src=\"ajx/imagenes/animadas/cargando.gif\" />";
