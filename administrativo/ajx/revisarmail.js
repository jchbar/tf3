...
// alert('1');
	var linea='ajx/revisarmail.php?email =' + document.getElementById('mail').value ; // +'&pp=' + document.getElementById('pwdvieja').value;
//	alert(linea);
...
function cambiopwd() {
//	alert('a')
document.getElementById('datos_ajax_register').innerHTML = ""; // + xmlDoc.getElementsByTagName("nombreseniat")[0].childNodes[0].nodeValue;
...
*/
	...
	document.getElementById('datos_ajax_register').innerHTML = 'Buscando informaci&oacuten ' +  document.getElementById('inputEmail').value+ "<img src=\"ajx/imagenes/animadas/cargando.gif\" />";
