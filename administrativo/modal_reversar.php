<form id="actualizarReverso" class='form-inline'>
<div class="modal fade" id="ReversarPago" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="exampleModalLabel">Modificar xxxxpaís:</h4>
		  </div>
...
-->
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="planilla" name="planilla" placeholder="Ultimos 8 digitos" readonly="readonly" required maxlength="8">
					</div>
					<div class="form-group">
						<label for="fechapago" class="control-label">Fecha de Pago:</label>
						<input type="text" class="form-control" id="fechapago" name="fechapago" required readonly="readonly"  maxlength="8">
					</div>
						<?php
/*					<div class="form-group">
