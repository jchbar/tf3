...
<html lang="en">
  ...
  <body>
	...
	// include("js_usuarios/modal_agregar_usuarios.php");
	// include("js_usuarios/modal_activar_usuarios.php");
	// include("js_usuarios/modal_eliminar_usuarios.php");
	include("js_notifica/modal_modificar_notifica.php");
	?>
    <div class="container-fluid">
	 
		<div class='col-xs-6'>	
			<h3>Usuarios para Notificacion de Acciones de Sistema</h3>
		</div>
<!--
		<div class='col-xs-6'>
			<h3 class='text-right'>		
...
-->		
	...
	<script src="js_notifica/app.js"></script>
	<script>
